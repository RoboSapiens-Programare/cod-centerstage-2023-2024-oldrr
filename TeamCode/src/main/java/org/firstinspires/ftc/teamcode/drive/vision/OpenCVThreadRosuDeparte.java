...
public class OpenCVThreadRosuDeparte extends Thread {
    static OpenCvWebcam Webcam;
    static PiramidaRosuDeparte pipeline;

    private PiramidaRosuDeparte.Location location;


    //Constructor
    public OpenCVThreadRosuDeparte(HardwareMap hardwareMap) {
        ...
        pipeline = new PiramidaRosuDeparte();
    ...
    public PiramidaRosuDeparte.Location getLocation(){
        return location;
    }
